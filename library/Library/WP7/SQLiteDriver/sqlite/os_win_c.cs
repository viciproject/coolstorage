...
public const int WIN_SHM_BASE  = ((22+SQLITE_SHM_NLOCK)*4);
public const int WIN_SHM_DMS  = (WIN_SHM_BASE+SQLITE_SHM_NLOCK);
...
//#define _SHM_RDLCK  2
//#define _SHM_WRLCK  3
public const int _SHM_UNLCK  =1;
public const int _SHM_RDLCK  =2;
public const int _SHM_WRLCK  =3;
