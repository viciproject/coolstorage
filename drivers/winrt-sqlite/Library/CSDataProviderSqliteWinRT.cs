...
{
    public class CSDataProviderSqliteWinRT : CSDataProvider
    {
        public CSDataProviderSqliteWinRT(string connectionString) : base(connectionString)
        {
        }
        ...
        {
            return new CSDataProviderSqliteWinRT(ConnectionString);
        }
        ...
        private class CSSqliteConnection : ICSDbConnection
        {
            ...
            {
                return new CSSqliteCommand((SqliteCommand) Connection.CreateCommand());
            }
