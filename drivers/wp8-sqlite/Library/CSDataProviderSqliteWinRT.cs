...
{
    public class CSDataProviderSqliteWP8 : CSDataProvider
    {
        public CSDataProviderSqliteWP8(string connectionString) : base(connectionString)
        {
        }
        ...
        {
            return new CSDataProviderSqliteWP8(ConnectionString);
        }
